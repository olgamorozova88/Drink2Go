# [Итоговая работа по курсу "Фронтенд-разработчик" от HTML Academy](https://olgamorozova88.github.io/Drink2Go/)
...
- Мобильное меню должно быть реализовано двумя способами:
  - реализация без JS - главное меню в мобильной версии должно быть открыто, а иконка с крестиком — скрыта. Должны быть предусмотрены классы для скрытого и открытого состояний меню.;
  - реализация с использованием JS - блок с главным меню в мобильной версии должен открываться при нажатии на иконку «гамбургера». Когда меню открыто, иконка «гамбургера» заменяется на крестик. При нажатии на иконку с крестиком меню закрывается.
- Промо блок — это слайдер. Сверстать и оживить слайдер. Для оживления слайдера использовать swiper.js
...
## Время затраченное на реализацию проекта

35,5 часов, для фиксации времени использован треккер - [Toggle Track](https://toggl.com/track/)
